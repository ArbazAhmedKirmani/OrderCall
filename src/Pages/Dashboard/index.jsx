...
import {
  bracketCounter,
  OperatorFunction,
} from "../../Functions/operatorFunctions";
...
const Dashboard = () => {
  ...
  const handleEqual = () => {
    ...
    else alert("Make sure brackets are closed");
  };
  ...
  const addAnswer = () => {
    ...
    else if (oldResult === "") alert("Answer is NULL");
    else alert("Answer can be used after an Operator");
  };
    ...
    <div id="container" className="container">
      ...
      <div style={{ position: "relative" }}>
        ...
        <span className="small-result">
          <b style={{ fontSize: 16, color: "gray" }}>= &nbsp;</b>
          {oldResult || 0}
        </span>
      </div>
      {/* \ Screen */}
